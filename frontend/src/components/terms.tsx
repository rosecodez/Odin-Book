    ...
    return (
        <div className="flex flex-col md:flex-row px-4 max-w-6xl mx-auto text-left">
            <div className="w-full md:w-1/4 pr-4 mb-8 md:mb-0">
                ...
                <ul className="pl-0">
                    <li><a href="#acceptance-of-terms" className="text-blue-500 hover:underline">Acceptance of Terms</a></li>
                    <li><a href="#user-accounts" className="text-blue-500 hover:underline">User Accounts</a></li>
                    <li><a href="#user-content" className="text-blue-500 hover:underline">User Content</a></li>
                    <li><a href="#privacy" className="text-blue-500 hover:underline">Privacy</a></li>
                    <li><a href="#prohibited-use" className="text-blue-500 hover:underline">Prohibited Use</a></li>
                    <li><a href="#termination" className="text-blue-500 hover:underline">Termination</a></li>
                    <li><a href="#intellectual-property"className="text-blue-500 hover:underline" >Intellectual Property</a></li>
                    <li><a href="#change-of-terms" className="text-blue-500 hover:underline">Changes to Terms</a></li>
            ...
            <div className="w-full md:w-3/4 space-y-8">
                ...
                <section className="p-2" id="user-content">
                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li>Violence, illegal activity, or copyrighted material without permission</li>
                    </ul>
                ...
                <section className="p-2" id="prohibited-use">
                    ...
                    <ul className="list-disc pl-5">
                        <li>Use bots, scrapers, or automated methods to access the site</li>
                        <li>Disrupt or damage the platform</li>
                        <li>Misuse other users' content or data</li>
                    </ul>
                    <p>We reserve the right to remove any content or account that violates these rules.</p>
                </section>
